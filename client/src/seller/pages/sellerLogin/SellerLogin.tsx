...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const promise = axios.post("/api/seller/seller-login", {
      ...
      <div className="md:py-5 flex items-center justify-center bg-gray-50 relative overflow-hidden">
        ...
        >
          ...
          <div className="text-right mt-3 mb-3">
            <span
              className="text-sm text-gray-800 relative cursor-pointer group"
              onClick={() => navigate("/seller/email-otp")}
            >
              Forgot Password?
