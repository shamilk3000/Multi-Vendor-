        ...
        <main className="px-4 md:px-0 py-2 md:py-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0">
          ...
          <div className="space-y-8 px-2 md:px-0">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Skeleton height={50} width={220} borderRadius={8} />
        ...
        <div className="max-w-7xl mx-auto px-4 mt-6 ">
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="bg-white rounded-2xl p-6 space-y-5 w-full max-w-md">
                {/* Heading Skeleton */}
                <div className="flex justify-center w-full">
                ...
                <div className="flex gap-2 justify-center">
                  {[...Array(5)].map((_, i) => (
                    <Skeleton key={i} width={28} height={28} circle />
                  ))}
                </div>

                {/* Textarea */}
                <Skeleton className="my-2" height={120} borderRadius={12} />

                {/* Button */}
                <Skeleton className="my-2" height={50} borderRadius={12} />
              </div>
            </div>
          </div>
        </div>
