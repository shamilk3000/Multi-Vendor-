      ...
      {paginatedProducts.map((product) => {
        ...
        return (
          <div
            ...
            className="group cursor-pointer w-full rounded-2xl overflow-hidden bg-linear-to-br from-white via-gray-50 to-gray-100 border border-gray-200 shadow-md hover:shadow-2xl hover:shadow-blue-200/40 transition-all duration-500 hover:scale-[1.04]"
          >
            {/* IMAGE */}
            ...
            <div className="p-4 bg-white/70 backdrop-blur-md">
              ...
              <div className="h-[2px] w-0 mt-2 bg-linear-to-r from-green-400 via-blue-500 to-purple-500 group-hover:w-full transition-all duration-500" />
            </div>
          </div>
        );
      })}
