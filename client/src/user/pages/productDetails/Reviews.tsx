...
import { useReviewForUser } from "../../../hooks/user/review/useReviews";

const Reviews = (productId: any) => {
  const { data: reviewsData = [], isLoading } = useReviewForUser(
    productId.productId,
  );
        ...
        {!isLoading && reviewsData.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 text-sm md:text-base max-w-md leading-relaxed">
              ...
              feedback helps other customers make better decisions.
            </p>
